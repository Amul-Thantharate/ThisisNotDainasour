...
st.set_page_config(
    page_title="This is Not a Dinosaur - Dino-Detective 🦖🕵️‍♂️",
    layout="centered"
)
...
st.link_button('Report Feedback, Issues, or Contribute!', "https://github.com/Amul-Thantharate/thisisnotadinosaur/issues", use_container_width=True)
